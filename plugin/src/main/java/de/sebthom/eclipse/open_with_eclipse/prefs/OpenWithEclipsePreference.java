...
import de.sebthom.eclipse.open_with_eclipse.OpenWithEclipsePlugin;
import net.sf.jstuff.core.io.RuntimeIOException;

/**
 * @author Sebastian Thomschke
 */
public final class OpenWithEclipsePreference {
   ...
   public static final IPersistentPreferenceStore STORE = OpenWithEclipsePlugin.get().getPreferenceStore();
   ...
   private OpenWithEclipsePreference() {
   }
}

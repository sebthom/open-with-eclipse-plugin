 ...
 */
public class OpenWithEclipsePlugin extends AbstractEclipsePlugin {

   /**
    * during runtime you can get ID with getBundle().getSymbolicName()
    */
   public static final String PLUGIN_ID = OpenWithEclipsePlugin.class.getPackage().getName().replace('_', '-');

   private static OpenWithEclipsePlugin instance;

   /**
    * @return the shared instance
    */
   public static OpenWithEclipsePlugin get() {
